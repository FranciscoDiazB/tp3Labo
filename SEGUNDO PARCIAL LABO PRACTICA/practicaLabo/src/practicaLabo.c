...
int main()
{
    ...
    LinkedList* listraFiltradaHoras;
    ...
    do {
    	...
    	case 10:
    		listaEmpleados = ll_map(listaEmpleados, employee_IncreaseSalary);

    		if(listaEmpleados != NULL){

    			printf("\nSueldos incrementados con exito");
    		}
    	...
    	case 11:
    		listraFiltradaHoras = ll_filter(listaEmpleados, employee_Filter200PlusHours);

    		if(listraFiltradaHoras != NULL){

    			controller_ListEmployee(listraFiltradaHoras);
    		}
    ...
    ll_deleteLinkedList(listraFiltradaHoras);
...
int menu(){
	...
	printf("10. Aumentar los sueldos de los empleados en un 10 porciento\n");
	printf("11. Filtrar los empleados con 200 horas o mas de trabajo\n");
	printf("12. Salir\n\n\n");
